...
var reminds__array = [["Passar na 1ª fase da UFPR",new Date('2024-10-20T14:00:00')],["Passar na 2ª fase da UFPR",new Date('2024-12-03T14:00:00')],["Abrir uma empresa",new Date('2025-06-24T00:00:00')],["Ler 10 livros",new Date('2025-01-01T00:00:00')],["Escrever um artigo científico",new Date('2025-09-28T14:00:00')]]
var remind__name = document.querySelector("#rem__name");
var remind__date = document.querySelector("#rem__date");

function addReminder() {
    if ((remind__name.value != "") && (remind__date.value != "")) {
        alert(remind__name.value+" "+remind__date.value)
        reminds__array.push([remind__name.value, new Date(remind__date.value)]);
    }
}
